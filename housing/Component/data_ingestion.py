...
class DataIngestion:
    ...
    def extract_tgz_file(self, tgz_file_path: str):
        try:
            ...
            with tarfile.open(tgz_file_path) as house_tgz_file_obj:
                house_tgz_file_obj.extractall(path=raw_data_dir)
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact:
        try:
            ...
            for train_index, test_index in data_split.split(housing_df, housing_df['income_cat']):
